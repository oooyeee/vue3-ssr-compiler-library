...
const { build, splitVendorChunkPlugin } = require("vite")
...
class VueToJsSSRCompiler {
    ...
    async render_all_views_for_ssr() {
        ...
        for (let file of files) {
            ...
            relpath = path.join(path.dirname(relpath), path.basename(relpath, path.extname(relpath)) + ".js") // if commonjs project needs to produce ESM files, use .mjs extension instead
